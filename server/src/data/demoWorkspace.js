...
const demoWorkspace = Object.freeze({
  designations: [
    {
  ...
  teams: [
    {
      ...
      description: "Owns APIs, deployment, and architecture.",
    },
    {
      id: "team_2",
      ...
      leadId: null,
      memberIds: ["usr_3"],
      description: "Owns desktop experience and workflow design.",
    },
  ],
  projects: [
    {
      ...
      status: "in_progress",
      description:
        "Desktop-first project management workspace for software teams.",
    ...
    },
    {
      ...
      canvas: {
        ...
        type: "excalidraw-like",
        elements: [
          { id: "r1", type: "rectangle", x: 160, y: 70, text: "Release Gate" },
          { id: "r2", type: "diamond", x: 420, y: 180, text: "Approve" },
        ],
      },
    },
    {
